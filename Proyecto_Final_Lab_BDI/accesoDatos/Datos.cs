...
namespace Proyecto_Final_Lab_BDI.accesoDatos
{
    class Datos
    {
        //Paso 1. Crear cadena de conexión.
        string cadenaConexion = @"Data Source=localhost:1521/xe; User Id=system; Password=oracle"; //contendrá la ip a la cual nos conectaremos, el user y su respectiva password.
